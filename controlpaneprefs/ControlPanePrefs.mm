...
@interface ControlPanePrefsListController: PSListController
- (void)respring;
- (void)followLogan;
@end

@implementation ControlPanePrefsListController
- (id)specifiers {
	if(_specifiers == nil) {
		_specifiers = [[self loadSpecifiersFromPlistName:@"ControlPanePrefs" target:self] retain];
	}
...
- (void)viewDidLoad {
    ...
    UIImage* customImg = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/ControlPanePrefs.bundle/twitterbutton.png"];
...
- (void)viewDidAppear:(BOOL)animated {
    NSString *iname = @"/Library/PreferenceBundles/ControlPanePrefs.bundle/ControlPanePrefs.png";
...
- (void)share:(UIBarButtonItem *)sender {
    ...
    [tweetComposeViewController setInitialText:@"#ControlPane - All your settings, in one place. Developed by @logandev22"];
...
@interface ControlPaneCustomCell : PSTableCell <PreferencesTableCustomView> {
	UILabel *label;
	UILabel *underLabel;
	UILabel *otherLabel;
}
...
@implementation ControlPaneCustomCell
- (id)initWithSpecifier:(id)specifier {
	...
	if (self) {
		...
		[underLabel setText:@"All your settings, in one place."];
